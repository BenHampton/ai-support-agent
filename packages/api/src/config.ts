...
// how hard we retry before falling back to the durable outbox. See integrations/zendesk.ts.
...
// background worker cadence for draining the escalation outbox once Zendesk recovers
